...
<head>
    ...
    <title>Toko Dua Libi | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url('assets/template/admin') ?>/index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Toko <b>Dua Libi</b></span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?= date('Y'); ?> <a href="http://adminlte.io">Toko Dua Libi</a>.</strong> All rights
            reserved.
        </footer>
