        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                    <div class="form-row">
                        <label for="barcode_name" class="col-form-label">Nama Barang</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="simpandata()"><i class="fa fa-paper-plane"></i> Simpan</button>
            </div>
        </div>
    </div>
</div>
