        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= site_url('dashboard') ?>">Transaksi</a></li>
                                    ...
                                    <div class="form-group">
                                        <select name="table" id="table" class="form-control">
                                            ...
                                            <?php foreach ($table as $t) { ?>
                                                <option value="<?= $t->id_table; ?>"><?= $t->nama_table; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </td>
                ...
                <div class="card">
                    <div class="card-body" style="height: 200px;">
                        <div align="right">
                            ...
                            <h1><b>Rp. <span id="grand_total2" style="font-size:50pt;">0</span></b></h1>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-lg-3">
                <div>
                    ...
                    <button id="process_payment" name="process_payment" class="btn btn-flat btn-lg btn-success">
                        <i class="fa fa-paper-plane"></i> Akhiri Pesanan
                    </button>
                </div>
            </div>
        </div>
