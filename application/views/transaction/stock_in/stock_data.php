                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="unit_name" class="col-form-label">Satuan</label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="float-sm-right">
                            <a onclick="tambahData()" class="btn btn-success btn-sm" style="color: aliceblue;"><i class="fa fa-plus"> Tambah Barang</i></a>
                        </div>
                    </div>
