        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Histori Stock Masuk</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="float-sm-right">
                    <a href="<?= site_url('in/add') ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"> Tambah Stock Masuk</i></a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($stock as $s) { ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-default btn-sm" id="select-detail" data-toggle="modal" data-target="#modal-detail" data-barcode="<?= $s->barcode; ?>" data-itemname=" <?= $s->item_name; ?>" data-qty="<?= $s->qty; ?>" data-date="<?= indo_date($s->date); ?>"><i class=" fa fa-eye"></i>
                                    </a>
